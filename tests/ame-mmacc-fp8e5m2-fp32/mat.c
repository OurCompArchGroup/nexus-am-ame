...
int main() {
  matrix_init();
  int failures = 0;
  failures += run_case("MMACC FP8 E5M2 -> FP32 case 0", matrix_mmacc0, mat_target);
  failures += run_case("MMACC FP8 E5M2 -> FP32 case 1", matrix_mmacc1, mat_target);
  failures += run_case("MMACC FP8 E5M2 -> FP32 case 2", matrix_mmacc2, mat_target);
  failures += run_case("MMACC FP8 E5M2 -> FP32 case 3", matrix_mmacc3, mat_target);
  failures += run_case("MMACC FP8 E5M2 -> FP32 double case", matrix_mmacc4,
                       mat_target_double);
