...
int main() {
  ...
  if (matrix_mfmacc0() == 0) {
    ...
    print_matrix_part("Matrix destination", mat_dist, 4, 4, 4);
    print_matrix_part("Matrix target", mat_target, 4, 4, 4);
  }
  matrix_restore();
  ...
  if (matrix_mfmacc1() == 0) {
    ...
    print_matrix_part("Matrix destination", mat_dist, 4, 4, 4);
    print_matrix_part("Matrix target", mat_target_n, 4, 4, 4);
  }
  matrix_restore();
